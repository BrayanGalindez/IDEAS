  ...
  return (
    <nav className="top-0 left-0 right-0 z-50 p-4 sm:p-1 md:p-5 bg-color-bg shadow-md w-full fixed">
      <div className="sm:flex items-center lg:mx-[150px] md:mx-6 sm:mx-3">
        ...
        {userData && (
          <ul
            className={`justify-end sm:flex justify-items-end sm:pb-0 absolute w-full sm:static left-0 transition-all ease-out duration-300 sm:z-auto z-[-1] bg-color-bg ${
          ...
          >
            <li className="mx-11 my-6 md:my-0 text-right">
              <a
                ...
                onClick={() => {
                  navigate("/balance");
                  setIsOpen(false); // Cerrar el menú al redirigir
                }}
              >
                Saldo
              </a>
