  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center min-h-screen">
        ...
        <div className="bg-white p-6 rounded max-w-sm mt-4">
          ...
          <div className="flex justify-center ">
            <Link to="/">
              <button className="font-[Open Sans] bg-color-button hover:bg-color-button-hover text-black px-4 py-2 rounded w-64">
                Iniciar sesión
              </button>
            </Link>
          </div>
